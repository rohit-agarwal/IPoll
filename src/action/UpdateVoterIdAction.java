...
public class UpdateVoterIdAction extends BaseAction{
						...
						if(!serv.getVoterIdByUser(user.getId()))
						{
									...
									&&req.getParameter("curState")!=null&&req.getParameter("curWardNo")!=null)
							{
								if(userPhoto!=null&&userPhotoContentType!=null&&userPhotoFilename!=null)
								{
									...
									if(userPhoto!=null)
									{
										if(serv.updateVoterId(name, surName, currAdd, currState, currCity, currWardNo, dob, userImage, pobAdd, id, fathersName, sex,
												relId, userImageContentType,userImageFileName,voterid))
										{
											return "done";
										}
										else
